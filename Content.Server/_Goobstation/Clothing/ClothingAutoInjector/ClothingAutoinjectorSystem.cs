...
namespace Content.Server._Goobstation.Clothing.ClothingAutoInjector;
...
public sealed partial class ClothingAutoinjectorSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent, ActionActivateAutoInjectorEvent>(OnInjectorActivated);
        SubscribeLocalEvent<Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent, GetItemActionsEvent>(OnEquipped);
        SubscribeLocalEvent<Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent, GotUnequippedEvent>(OnUnequipped);
        SubscribeLocalEvent<Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent, ExaminedEvent>(OnExamined);
        SubscribeLocalEvent<MobStateChangedEvent>(OnMobStateChange);
        SubscribeLocalEvent<Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent, InventoryRelayedEvent<ClothingAutoInjectRelayedEvent>>(OnInject);
    }

    private void OnInjectorActivated(EntityUid uid, Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent component, ref ActionActivateAutoInjectorEvent args)
    {
        if (args.Handled)
            return;
    ...
    private void OnInject(EntityUid uid, Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent comp, InventoryRelayedEvent<ClothingAutoInjectRelayedEvent> args)
    {
    ...
    private void OnEquipped(EntityUid uid, Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent component, ref GetItemActionsEvent args)
    {
        if (args.InHands)
            return;
    ...
    private void OnUnequipped(EntityUid uid, Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent component, ref GotUnequippedEvent args)
    {
        if (component.AutoInjectOnAbility)
            _actions.RemoveProvidedActions(args.Equipee, uid);
    }

    private void OnExamined(EntityUid uid, Shared._Goobstation.Clothing.Components.ClothingAutoInjectComponent component, ref ExaminedEvent args)
    {
