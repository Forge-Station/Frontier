...
public sealed partial class DNALockerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<_ADT.DNALocker.Components.DNALockerComponent, GetVerbsEvent<AlternativeVerb>>(OnAltVerb);
    ...
    private void OnAltVerb(EntityUid uid, _ADT.DNALocker.Components.DNALockerComponent component, GetVerbsEvent<AlternativeVerb> args)
    {
