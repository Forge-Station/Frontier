...
using Content.Client.UserInterface.Systems.Language; // Forge-change
...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly LanguageMenuUIController _language = default!; // Forge-change: EE Language
    ...
    public void UnloadButtons()
    {
        ...
        _language.UnloadButton(); // Forge-change: EE Language
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _language.LoadButton(); // Forge-change: EE Language
    }
}
