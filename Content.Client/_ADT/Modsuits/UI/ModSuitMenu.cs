...
public sealed partial class ModSuitMenu : FancyWindow
{
    ...
    public void UpdateModuleView(ModBoundUiState state)
    {
        ...
        foreach (var item in list)
        {
            ...
            control.EjectButton.ModulateSelfOverride = new Color(0.18f, 0.25f, 0.35f);
            ...
            if (modulecomp.Active)
            {
                ...
                control.ActivateButton.ModulateSelfOverride = new Color(0.04f, 0.06f, 0.10f);
                control.DeactivateButton.ModulateSelfOverride = new Color(0.18f, 0.25f, 0.35f);
            }
            else
            {
                ...
                control.ActivateButton.ModulateSelfOverride = new Color(0.18f, 0.25f, 0.35f);
                control.DeactivateButton.ModulateSelfOverride = new Color(0.04f, 0.06f, 0.10f);
            }
