...
public sealed partial class SharedDNAGunLockerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<_ADT.DNAGunLocker.DNAGunLockerComponent, GetVerbsEvent<AlternativeVerb>>(OnAltVerbs);
    ...
    private void OnAltVerbs(EntityUid uid, _ADT.DNAGunLocker.DNAGunLockerComponent component, GetVerbsEvent<AlternativeVerb> args)
    {
