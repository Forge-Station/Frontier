...
public abstract class SharedTranslatorSystem : EntitySystem
{
    ...
    protected void OnAppearanceChange(EntityUid translator, HandheldTranslatorComponent? comp = null)
    {
        ...
        _appearance.SetData(translator, ToggleableVisuals.Enabled, comp.Enabled); // Forge-change: ToggleVisuals.Toggled>ToggleableVisuals.Enabled, Wizden#35341 compliance
    }
}
